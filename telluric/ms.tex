...
The current best RV precision is around 1~m/s, attainable via two
wavelength calibration methods: ThAr lamp emission line calibration
(e.g., ELODIE and HARPS; \citealt{elodie, harps-s}) and iodine cell
absorption line calibration (e.g., Keck/HIRES; \citealt{butler1996}).
