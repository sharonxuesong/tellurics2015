...
Cells as Calibrators\altaffilmark{1}
}
...
precision in the near infra-red region (e.g.,
...
m/s. \cite{artigau2014} uses principal component analysis (PCA) to
...
$\sim$20~cm/s (and more significantly for the $\sim$630~nm region).

% I'm here:
This paper focuses on the adverse effects of telluric contamination
and its remedies under the context of iodine-calibrated precise RV,
especially for ``micro-telluric" lines (shallow telluric absorption
lines with $<1$-3\% depths; \citealt{cunha2014}). As for spectral
region contaminated with deep telluric lines, typical precise RV
analysis usually gives 

Previously, \cite{cunha2014} have characterized the effects of
micro-telluric contamination and proposed solution for the
ThAr-calibrated HARPS-S data. 
